...
(cl:defmethod cl:initialize-instance :after ((m <AddIntsFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddIntsFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name action_communication-msg:<AddIntsFeedback> is deprecated: use action_communication-msg:AddIntsFeedback instead.")))

(cl:ensure-generic-function 'progress_bar-val :lambda-list '(m))
(cl:defmethod progress_bar-val ((m <AddIntsFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader action_communication-msg:progress_bar-val is deprecated.  Use action_communication-msg:progress_bar instead.")
  (progress_bar m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddIntsFeedback>)))
  ...
  "action_communication/AddIntsFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddIntsFeedback)))
  "Returns string type for a message object of type 'AddIntsFeedback"
  "action_communication/AddIntsFeedback")
